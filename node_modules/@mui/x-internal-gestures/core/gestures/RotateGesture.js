 ...
 */
class RotateGesture extends _PointerGesture.PointerGesture {
  state = {
    startAngle: 0,
    lastAngle: 0,
    totalRotation: 0,
  ...
  clone(overrides) {
    return new RotateGesture((0, _extends2.default)({
      name: this.name,
    ...
    switch (event.type) {
      case 'pointerdown':
        if (relevantPointers.length >= 2 && !this.isActive) {
          ...
          const initialAngle = (0, _utils.calculateRotationAngle)(relevantPointers);
      ...
      case 'pointermove':
        if (relevantPointers.length >= 2) {
          ...
          const currentAngle = (0, _utils.calculateRotationAngle)(relevantPointers);
      ...
      case 'forceCancel':
        if (this.isActive) {
          ...
          if (remainingPointers.length < this.minPointers) {
            ...
            const newAngle = (0, _utils.calculateRotationAngle)(remainingPointers);
