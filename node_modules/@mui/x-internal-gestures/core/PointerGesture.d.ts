...
import { Gesture, GestureEventData, GestureOptions } from "./Gesture.js";
 ...
 */
export interface PointerGestureOptions<GestureName extends string> extends GestureOptions<GestureName> {
  /**
